...
norm_size = 128
CHANNELS = 3
img_dim = (norm_size,norm_size,CHANNELS)
filepath='/home/zhzhao/Desktop/densenet_my/invoice-code_ok/dataset/trained_best_weights.h5'
...
def load_data2(path):
    ...
    data = []
    labels = []
    #print(list(paths.list_images(path)))
...
def train(aug,trainX,trainY,testX,testY,args):
    ...
    model = createDenseNet(CLASS_NUM, img_dim, depth=40, nb_dense_block=3, growth_rate=12, nb_filter=16, dropout_rate=None,
                     weight_decay=1E-4, verbose=True)
    #LeNet.build(width=norm_size, height=norm_size, depth=3, classes=CLASS_NUM)
