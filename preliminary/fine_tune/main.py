...
base_log_dir = '/home/jychen/xuelang/code_7/logs'
...
model.load_weights(model_save_path)#(model_save_path,by_name=True,skip_mismatch=True)
...
train_generator = train_datagen.flow_from_directory(
        '/home/jychen/xuelang/code_2/code/data_2/imgtrain/',
        target_size=imgsize,
...
validation_generator = val_datagen.flow_from_directory(
        '/home/jychen/xuelang/code_2/code/data_2/imgval/',
        target_size=imgsize,
        batch_size=batch_size,
        class_mode='binary',
        interpolation="bicubic"
